...
class LCAEnv(Env):
    ...
    def __init__(self):
        ...
        self.observation_space = Box(low=np.array([0,0,3.43,1.36,0,800]), high=np.array([50,50,6.37,3.76,6,1200]))
        ...
        #Set State Array
        self.state = np.array([self.t,self.age,self.sn,self.iri,self.scen,self.aadtt])
